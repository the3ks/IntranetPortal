  ...
  return (
    <MainLayout>
      <div className="max-w-7xl mx-auto py-8 space-y-8">
        <header>
          <h1 className="text-3xl font-extrabold text-foreground">Site Administration</h1>
          <p className="mt-2 text-foreground/60 text-lg">Provision and manage physical geographical structures mapping the corporate matrix.</p>
        </header>
        ...
        <div className="bg-card p-6 sm:p-8 rounded-3xl shadow-sm border border-border/50 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex-1 w-full">
            ...
            <form action={createSiteAction} className="grid grid-cols-1 sm:grid-cols-[1fr_1fr_auto] gap-4">
              <input type="text" name="name" required placeholder="Site Name (e.g. Tokyo Data Center)" className="px-5 py-2.5 rounded-xl border border-border/50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-foreground shadow-sm bg-background/50" />
              <input type="text" name="address" placeholder="Physical Address (Optional)" className="px-5 py-2.5 rounded-xl border border-border/50 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-foreground shadow-sm bg-background/50" />
