  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex justify-between items-center bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Your Assigned Hardware</h2>
          <p className="text-sm text-gray-500 mt-1">Review the capital assets currently in your physical custody.</p>
        </div>
        <div className="bg-white p-3 rounded-xl shadow-sm border border-gray-100 font-mono text-sm text-blue-700">
      ...
      {assets.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {assets.map((asset) => (
            <div key={asset.id} className="group relative bg-white border border-gray-100 rounded-3xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="bg-gray-50 h-12 w-12 rounded-2xl flex items-center justify-center mb-4 text-gray-700 border border-gray-100 group-hover:bg-blue-600 group-hover:text-white transition-colors">
              ...
              <h3 className="font-bold text-gray-900 text-lg">{asset.modelName || "Generic Asset"}</h3>
              <p className="text-sm text-gray-500 mb-4">{asset.manufacturer}</p>
              
              <div className="space-y-2 mt-4 pt-4 border-t border-gray-50 font-mono text-xs text-gray-600">
