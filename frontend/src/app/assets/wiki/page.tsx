  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-8 prose max-w-none prose-emerald prose-headings:text-gray-800 prose-p:text-gray-600 prose-strong:text-gray-900">
          
          <h3 className="text-xl font-bold mt-0 mb-4 border-b border-gray-100 pb-2">1. For General Employees</h3>
          <p className="mb-6">
          ...
          <h3 className="text-xl font-bold mt-10 mb-4 border-b border-gray-100 pb-2">2. For Line Managers</h3>
          <p className="mb-6">
          ...
          <h3 className="text-xl font-bold mt-10 mb-4 border-b border-gray-100 pb-2">3. For Administrators & Fulfillment Agents</h3>
