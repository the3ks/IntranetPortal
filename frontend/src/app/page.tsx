  ...
  return (
    <MainLayout hideSidebar>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
        ...
        <Link href="/assets" className="group bg-white p-8 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 hover:border-emerald-200 transition-all transform hover:-translate-y-1 block relative overflow-hidden">
          <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-50/50 rounded-full blur-3xl -mr-16 -mt-16 group-hover:bg-emerald-100/70 transition-colors"></div>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-emerald-700 transition-colors">Assets Management</h3>
          <p className="text-gray-500 font-medium leading-relaxed">Submit requisitions and track physical equipment deployments, inventory, and accessories.</p>
        </Link>
