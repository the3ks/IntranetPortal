    ...
    <form action={action} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <input type="text" name="fullName" defaultValue={employee?.fullName} required className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm" placeholder="e.g. John Doe" />
        </div>
        <div className="space-y-2">
          <label className="text-sm font-bold text-gray-700">Email Address</label>
          <input type="email" name="email" defaultValue={employee?.email} required className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm" placeholder="john.doe@company.com" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-6 mt-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-bold text-gray-700">Geographic Site Boundaries</label>
        ...
        <div className="space-y-2">
          ...
          <select name="departmentId" value={selectedDeptId} onChange={handleDeptChange} required className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white shadow-sm appearance-none">
      ...
      <div className="pt-6 pb-2 border-t border-gray-100 flex items-center justify-between">
        <div>
          <h4 className="text-sm font-bold text-gray-900">Software Access Provisioning</h4>
          <p className="text-xs font-medium text-gray-500">Automatically generate or sustain an active Login Credential for this personnel.</p>
        </div>
