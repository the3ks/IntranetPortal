          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 w-full">
              ...
              <form action={createSiteAction} className="grid grid-cols-1 sm:grid-cols-[1fr_1fr_auto] gap-4">
                <input type="text" name="name" required placeholder="Site Name (e.g. Tokyo Data Center)" className="px-5 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-gray-800 shadow-sm" />
                <input type="text" name="address" placeholder="Physical Address (Optional)" className="px-5 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-gray-800 shadow-sm" />
