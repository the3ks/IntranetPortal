        ...
        <nav className="flex flex-col space-y-2 flex-1 overflow-y-auto overflow-x-hidden elegant-scrollbar pb-4 pr-1">
          ...
          {activeModule === "admin" && isAdmin && (
            <>
              ...
              <Link href="/admin/positions" className={`hover:bg-gray-800 hover:text-white px-4 py-3 rounded-xl transition-all font-medium flex items-center space-x-3 ${isLinkActive('/admin/positions') ? 'bg-gray-800 text-white shadow-sm' : ''}`}>
