...
namespace IntranetPortal.Data.Migrations
{
    ...
    [Migration("20260426142357_FinalizePersonnelUnification")]
    partial class FinalizePersonnelUnification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IntranetPortal.Data.Models.UserAccount", b =>
                {
                    b.HasOne("IntranetPortal.Data.Models.HR.Employee", "Employee")
                        .WithOne("UserAccount")
                        .HasForeignKey("IntranetPortal.Data.Models.UserAccount", "EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
